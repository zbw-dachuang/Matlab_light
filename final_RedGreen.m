function varargout = final_RedGreen(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @final_RedGreen_OpeningFcn, ...
                   'gui_OutputFcn',  @final_RedGreen_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function final_RedGreen_OpeningFcn(hObject, eventdata, handles, varargin)
...
handles.pathout = '/Users/cx/Desktop/RedGreenResult.csv'; % 自定义结果输出路径
...
function varargout = final_RedGreen_OutputFcn(hObject, eventdata, handles)
% 最大化显示
